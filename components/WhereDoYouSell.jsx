...
const productOptions = [
  {
    ...
    subtitle: 'Create a fully customizable website',
    icon: StoreIcon,
  },
  {
    title: 'In person at a retail store', 
    subtitle: 'Brick-and-mortar stores',
    icon: <FaChair />,
  },
  {
    title: 'In person at events', 
    subtitle: 'Markets, fairs, and pop-ups',
    icon: <FaStore />,
  },
  {
    title: 'An existing website or blog', 
    subtitle: 'Add a Buy Button to your website',
    icon: BlogIcon,
  },
  {
    title: 'Social media', 
  ...
  },
  {
    ...
    subtitle: 'Etsy, Amazon, and more',
    icon: AffiliateIcon,
  },
];

const Wheredoyousell = () => {
...
const navigate = useNavigate();
  ...
  return (
    <Container>
      <Card>
        <Title>Where do you currently sell?</Title>
        ...
        <Navigation>
          ...
          <NextButton onClick={() => navigate('/business-status')}>
            Next <FiChevronRight />
          </NextButton>
        </Navigation>
      </Card>
